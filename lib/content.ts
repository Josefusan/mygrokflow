...
export const RATES = [
  ...
  },
  {
    ...
    badge: "",
    included: [
      "One client-outbound lane built and run for you",
      "Hiring-manager lists in one specialty",
      "Cold email and follow-up on autopilot",
  ...
  },
  {
    ...
    badge: "Best value",
    included: [
      "Everything in the starter lane",
      "Multi-channel outreach: email, LinkedIn, and X",
      "Hiring-signal triggers that time your outreach",
      "Deeper integration across the tools you already run",
      "Weekly reporting on booked calls and job orders",
    ],
    excluded: [
      "Candidate sourcing",
  ...
  },
  {
    ...
    included: [
      ...
      "Highest volume and priority build",
      "Dedicated async support",
      "Custom reporting and pipeline reviews",
    ],
    excluded: [
      "Candidate sourcing",
