...
export const RATES = [
  {
    ...
    suffix: "audit",
    included: [
      "Your niche and current outreach on the table",
      "Written plan of what we would automate",
  ...
  {
    title: "$1,500/mo + $300/call",
    eyebrow: "Monthly + per call",
    price: "$1,500",
    suffix: "/mo + $300/call",
    included: [
      "$300 per sales call our system books for you",
      "The client-outbound system, built and run for you",
      "Lists, cold email, and follow-up in one specialty",
      "Reply handling and calendar handoff",
    ],
    excluded: [
      "A second unrelated specialty",
      "Candidate sourcing",
  ...
  {
    title: "$2,000/mo + $150/call",
    eyebrow: "Monthly + per call",
    price: "$2,000",
    suffix: "/mo + $150/call",
    included: [
      "$150 per sales call our system books for you",
      "Higher base, lower cost per booked call",
      "Multi-channel outreach: email, LinkedIn, and X",
      "Deeper integration across the tools you already run",
    ],
    excluded: [
      "Candidate sourcing",
      "Unlimited new specialties",
      "A product you resell",
      "Staff augmentation",
    ],
  },
  {
    title: "$4,500/mo + $100/call",
    eyebrow: "Monthly + per call",
    price: "$4,500",
    suffix: "/mo + $100/call",
    included: [
      "$100 per sales call our system books for you",
      "Highest base, lowest cost per booked call",
      "Multiple outbound lanes across your desks",
      "Priority build and async support",
    ],
    excluded: [
      "Candidate sourcing",
