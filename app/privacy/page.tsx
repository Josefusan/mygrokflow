      ...
      <main id="main" className="mx-auto max-w-[42rem] px-4 py-16">
        ...
        <section className="mt-12">
          ...
          <p className="mt-4 text-[15px] leading-relaxed">
            ...
            configured or fails, mailto remains available and /apply still
            succeeds. If you subscribe to Without You, we receive the email
            address you enter. Collection is native /apply only. No free-text
