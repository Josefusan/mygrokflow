...
export function LandingNav() {
  ...
  return (
    <nav
      aria-label="Primary"
      className="fixed inset-x-0 top-0 z-10 flex items-center justify-between border-b border-(--mgf-border) bg-(--mgf-nav) px-8 py-5 max-[900px]:px-[18px] max-[900px]:py-4"
    >
      <FadeUp delay={0}>
        <a
          href="#top"
      ...
      <ul className="flex items-center gap-12 max-[960px]:hidden">
