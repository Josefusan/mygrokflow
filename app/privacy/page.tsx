      ...
      <main id="main" className="mx-auto max-w-[42rem] px-4 py-16">
        ...
        <section className="mt-12">
          ...
          <p className="mt-4 text-[15px] leading-relaxed">
            ...
            {DIAGNOSTIC_EMAIL}. Without You is a Wednesday note on Substack;
            tapping Subscribe on Substack leaves this site. We do not collect a
            Substack signup here. Collection is native /apply only. No free-text
